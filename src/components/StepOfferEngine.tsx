            ...
            {form.products.map((product, i) => (
              ...
              >
                <div style={{ display: "flex", gap: 16 }}>
                  <div style={{ width: 100, height: 100, flexShrink: 0, borderRadius: 14, overflow: "hidden", background: "rgba(255,255,255,0.03)", cursor: "none", position: "relative" }}>
                    {product.image ? (
                      <img
                        src={product.image}
                        alt=""
                        ...
                        onClick={() => {
                          ...
                          input.onchange = (e: any) => {
                            ...
                            reader.onload = () => updateProduct(product.id, { image: reader.result as string })
